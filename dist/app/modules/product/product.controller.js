...
const addProduct = (0, tryCatch_1.default)((req, res) =>
...
const cloneProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_service_1.ProductService.cloneProduct(
      req.body
    );
    (0, sendResponse_1.default)(res, {
      success: true,
...
const allProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const paginationData = (0, PickValidField_1.pickField)(req.query, [
      "page",
      "limit",
      "sort",
    ]);
    const filter = (0, PickValidField_1.pickField)(req.query, [
      "searchTerm",
      "categoryId",
    ]);
...
const singleProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
const updateProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const user = req.user;
...
const deleteProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const user = req.user;
...
const flashProduct = (0, tryCatch_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
